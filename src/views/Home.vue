            ...
            <el-carousel :autoplay="auto" :interval="4000" class="suggest-banner" arrow="always"
                ...
                <el-carousel-item v-for="(item,idx) in hotTemplateData" :key="idx">
                    <div class="banner-inner">
                        &lt;!&ndash;<router-link target="_blank" :to="'/sysTemplate/detail/'+innerItem.templateId" class="show-item" v-for="(innerItem,innerIdx) in item" :key="innerItem.templateId" v-if="innerIdx<4">&ndash;&gt;
                        &lt;!&ndash;<div :to="'/sysTemplate/detail/'+innerItem.templateId" class="show-item"
